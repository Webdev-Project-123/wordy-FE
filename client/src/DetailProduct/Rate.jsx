        ...
        <div className=" flex flex-row m-4 text-lg flex-wrap justify-center items-center">
          ...
          <div className="flex flex-col items-center justify-center lg:ml-[25px]">
            <div className="flex  items-end text-3xl">
              <p className="text-7xl text-yellow-400">
                {" "}
                {Average(props.rate["productRate"])}{" "}
              </p>
              /5
            </div>
            <div>
              <Rating avg={Average(props.rate["productRate"])} />
            </div>
            <p className="text-base text-stone-500">
              (Have {SumStar(props.rate["productRate"])} rating)
            </p>
          </div>
          ...
          <div className="lg:ml-[100px] md:ml-[25px] mt-[20px]">
            {props.rate["productComments"].map((comment) => (
          ...
          <div className="flex flex-col lg:mt-0 mt-[10px]">
            ...
            <div className=" flex flex-col h-[100%]">
              ...
              <input
                className=" rounded-xl placeholder:italic placeholder:text-sm border-solid border-2 border-indigo-600"
                name=""
                id=""
                required
                placeholder="Number..."
            ...
            <input
              className=" rounded-xl cursor-pointer w-[100px] h-[30px] bg-orange-500 text-white mt-[15px]"
              type="submit"
              value="SEND"
              onClick={() =>
                handleNotify("⚠️Please buy this product before rating")
              }
            />
            <div>
              <p className=" text-center animate-pulse text-red-600 font-bold mt-[20px] max-w-[200px] text-sm">
                {notify}
              </p>
            </div>
          </div>
