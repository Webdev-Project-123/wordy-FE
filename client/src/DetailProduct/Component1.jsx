  ...
  return (
    <div className="bg-[#FCECDD] lg:h-[500px] h-max lg:py-0 py-[20px] flex justify-center items-center lg:text-lg sm:text-sm">
      <div className="flex flex-wrap  justify-center  ">
        {/*Image */}
        <div
          className="flex justify-center items-center bg-[#fff] lg:w-[500px] lg:h-[450px] w-[340px] h-[340px] rounded-3xl
        ...
        {/*Detail */}
        <div
          className=" bg-[#ffffff] lg:mt-0 md:mt-0 mt-[20px] lg:h-[450px] lg:min-w-[600px] sm:h-max sm:max-w-sm mx-[10px] 
        ...
        >
          <div className="px-[10px]">
            ...
            <div className="mt-[10px] flex flex-wrap items-center">
              ...
              <p className="text-sm ml-[30px] font-semibold">
                Return products in one month
              </p>
              <a
                href="#"
                className="text-base ml-[28px] text-sky-500 font-semibold"
              >
                More informations
              </a>
            </div>
            ...
            <div className="mt-[10px] flex flex-wrap items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6 text-sm text-[#61B15A]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
            ...
            <div className="flex flex-wrap mt-[10px] items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6 text-sm text-violet-900"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
              ...
              <div>
                <select
                  className="ml-[20px] h-[32px] w-[125px] bg-[#1691d8] text-white rounded-2xl cursor-pointer
            ...
            <div className="mt-[20px] justify-center flex text-white h-[50px]">
              ...
              >
                <div className="flex items-center  justify-center">
                  ...
                  <p className="pl-[10px]">Add to the cart</p>
                </div>
              </button>
            </div>
          </div>
