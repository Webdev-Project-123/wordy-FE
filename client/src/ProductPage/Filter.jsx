...
const Filter = () => {
  ...
  return (
    <div className="min-w-[200px] ml-2 sm:ml-16 ">
      <div
        onClick={toggle}
      ...
      <div
        className={
          "md:block hidden w-full cursor-pointer bg-white rounded-lg h-fit"
        }
      >
        <div className="py-2 font-extrabold text-center text-xl bg-[#FEA82F] rounded-t-lg">
          CATEGORY
        </div>
        <nav>
