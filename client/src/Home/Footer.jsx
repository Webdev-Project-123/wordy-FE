...
const Footer = () => {
  return (
    <div className="flex flex-col space-y-2 px-8 md:flex-row md:px-16 py-5 bg-[#FF6701] text-white  sm:gap-8">
      <div className="flex-1 space-y-2">
        ...
        <p className="text-sm font-light leading-tight sm:leading-normal">
          ...
          Get the best books at <b>Wordy</b>.
        </p>
      ...
      <h1 className="flex-1 flex flex-wrap md:hidden">
        <div className="font-sans font-semibold w-[137px]">
          <p className="flex justify-between cursor-pointer">SERVICE</p>
          <ul className="font-light text-sm cursor-pointer mt-2">
            <li>Terms of use</li>
            <li>Privacy Policy</li>
            <li>Press & Media</li>
        ...
        <div className=" font-sans font-semibold ml-8">
          <p className="flex justify-between cursor-pointer">SUPPORT</p>
          <ul className="font-light text-sm cursor-pointer mt-2">
            <li>How to return</li>
            <li>Shipping</li>
            <li>How to pay</li>
